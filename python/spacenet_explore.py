...
def main():   
    ...
    maskDir_vis = output_dir + '/building_mask_vis/'
    mask_demo_dir = output_dir + '/mask_demo/'

    distDir = output_dir + '/distance_trans/'
    dist_demo_dir = output_dir + '/distance_trans_demo/'

    all_demo_dir = output_dir + '/all_demo/'
